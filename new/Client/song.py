...
class Song:
    ...
    def get_star_image(self):
        ...
        full_star_image = Image.open("new\\Client\\images\\full_star.png")  # Full star image
        half_star_image = Image.open("new\\Client\\images\\half_star.png")
        empty_star_image = Image.open("new\\Client\\images\\empty_star.png")
